...
// A API da Olist/Tiny interpreta dataInicial/dataAtualizacao no horário do
// Brasil, mas o servidor roda em UTC — formatar com getDate()/getHours()
// locais empurraria o filtro 3h para o futuro (após as 21h o cursor cairia
// no dia seguinte e a sync de "hoje" voltaria vazia).
const OLIST_TIMEZONE = "America/Sao_Paulo";

function olistDateParts(value: string) {
