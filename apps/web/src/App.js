...
export default function App() {
    ...
    if (loading) {
        return _jsx("div", { className: "page-loading fullscreen", children: "Carregando sess\u00E3o..." });
    }
    if (!token) {
        return (_jsx(Suspense, { fallback: _jsx("div", { className: "page-loading fullscreen", children: "Carregando sess\u00E3o..." }), children: _jsx(LoginPage, {}) }));
    }
