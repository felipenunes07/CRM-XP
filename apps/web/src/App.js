...
export default function App() {
    return (_jsx(Suspense, { fallback: _jsx("div", { className: "page-loading fullscreen", children: "Carregando tela..." }), children: _jsxs(Routes, { children: [_jsxs(Route, { element: _jsx(AppShell, {}), children: [_jsx(Route, { path: "/", element: _jsx(DashboardPage, {}) }), _jsx(Route, { path: "/atendentes", element: _jsx(AttendantsPage, {}) }), _jsx(Route, { path: "/clientes", element: _jsx(CustomersPage, {}) }), _jsx(Route, { path: "/embaixadores", element: _jsx(AmbassadorsPage, {}) }), _jsx(Route, { path: "/clientes/:id", element: _jsx(CustomerDetailPage, {}) }), _jsx(Route, { path: "/segmentos", element: _jsx(SegmentsPage, {}) }), _jsx(Route, { path: "/agenda", element: _jsx(AgendaPage, {}) }), _jsx(Route, { path: "/clientes-novos", element: _jsx(NewCustomersPage, {}) }), _jsx(Route, { path: "/reativacao", element: _jsx(ReactivationPage, {}) }), _jsx(Route, { path: "/mensagens", element: _jsx(MessagesPage, {}) }), _jsx(Route, { path: "/disparador", element: _jsx(DisparadorPage, {}) }), _jsx(Route, { path: "/rotulos", element: _jsx(LabelsPage, {}) }), _jsx(Route, { path: "/prospeccao", element: _jsx(ProspectingPage, {}) })] }), _jsx(Route, { path: "*", element: _jsx(Navigate, { to: "/", replace: true }) })] }) }));
}
