...
export function CustomerMovementsPanel({ initialDays = 7 }) {
    ...
    const filteredMovements = movements.filter((m) => {
        ...
        if (activeTab === "deterioration") {
            ...
            return (m.toStatus === "ACTIVE" && (m.fromStatus === "ATTENTION" || m.fromStatus === "INACTIVE"));
        }
    });
