...
describe("SalesPerformancePanel", () => {
    ...
    it("shows today's ranking ordered by pieces and keeps sem atendente visible for reconciliation", () => {
        const markup = renderToStaticMarkup(_jsx(SalesPerformancePanel, { salesPerformance: salesPerformance, reactivationLeaderboard: [], newCustomerLeaderboard: [], prospectingLeaderboard: [], rankingPeriod: "today" }));
    ...
    it("keeps sem atendente hidden in the monthly ranking", () => {
        const markup = renderToStaticMarkup(_jsx(SalesPerformancePanel, { salesPerformance: salesPerformance, reactivationLeaderboard: [], newCustomerLeaderboard: [], prospectingLeaderboard: [], rankingPeriod: "month" }));
