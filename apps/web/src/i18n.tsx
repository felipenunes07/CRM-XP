...
const extraExactTranslations: Record<string, string> = {
  ...
  Análise: "分析",
  "Análise por SKU": "按 SKU 分析",
  "Compare estoque, giro e necessidade de compra de cada SKU em uma única visão.": "在一个视图中比较每个 SKU 的库存、周转和采购需求。",
  Decisão: "采购决策",
  "Não comprar": "暂不采购",
  "Peças nos filtros": "筛选范围内库存件数",
  "SKUs encontrados": "找到的 SKU",
  "Vendas em 30 dias": "30 天销量",
  "Somente os SKUs exibidos": "仅统计当前显示的 SKU",
  "Prioridade de reposição": "补货优先级",
  "Sem venda há 60+ dias": "60 天以上未销售",
  "Inclui SKUs sem venda registrada": "包括没有销售记录的 SKU",
  "Visão para decisão": "决策视图",
  "SKUs para analisar": "待分析 SKU",
  "Compare estoque, giro e última venda; clique em uma linha para ver o diagnóstico.": "比较库存、周转和最近销售；点击一行查看诊断。",
  "Prioridade de compra": "采购优先级",
  "Maior estoque": "库存最多",
  "Mais vendidos em 30 dias": "30 天销量最多",
  "Mais vendidos em 90 dias": "90 天销量最多",
  "Venda mais recente": "最近销售",
  "SKU / modelo": "SKU / 型号",
  Estoque: "库存",
  "Venda 30d": "30 天销量",
  "Última venda": "最近销售",
  "Carregando análise dos SKUs...": "正在加载 SKU 分析...",
  "Nenhum SKU corresponde aos filtros selecionados.": "没有 SKU 符合所选筛选条件。",
  "Carregando diagnóstico do SKU...": "正在加载 SKU 诊断...",
  "Selecione um SKU na tabela para abrir o diagnóstico completo.": "请在表格中选择一个 SKU 以查看完整诊断。",
  "Diagnóstico selecionado": "已选诊断",
  "Sem qualidade informada": "未提供品质",
  "Orientação de compra": "采购建议",
  "variações com saldo": "个有库存的变体",
  "Vendas em 90 dias": "90 天销量",
  "pedidos no período": "个周期内订单",
  "Cobertura estimada": "预计覆盖天数",
  Movimentação: "库存变动",
  "Estoque, vendas e reposições": "库存、销量与补货",
  "Veja se a entrada de peças realmente virou venda depois da reposição.": "查看补货入库后是否真正转化为销售。",
  "Ainda não há histórico diário suficiente para este SKU.": "该 SKU 暂无足够的每日历史数据。",
  "Leitura recomendada": "建议解读",
  "O que merece atenção neste SKU": "此 SKU 值得关注的事项",
  "Comparação histórica": "历史对比",
  "Efeito do nível de estoque": "库存水平的影响",
  "Efeito da variedade disponível": "可用品类丰富度的影响",
  "Depósitos e saldo": "仓库与库存",
  "Sem empresa informada": "未提供公司",
  "reservadas": "已预留",
  Demanda: "需求",
  "histórico deste SKU.": "该 SKU 的历史记录。",
  Composição: "组成",
  "Variações do SKU": "SKU 变体",
  "em estoque": "在库",
  "vendas em 90d": "90 天销量",
  "Sem variações vinculadas a este SKU.": "该 SKU 没有关联变体。",
  "Quem compra este modelo": "购买此型号的客户",
  "Ranking pelo volume total. A média mensal considera até os últimos 12 meses de histórico de cada cliente.": "按累计购买量排序；月均值最多统计每位客户最近 12 个月的历史。",
  Fechar: "关闭",
  "Carregando histórico dos clientes...": "正在加载客户购买历史...",
  "Não foi possível carregar os clientes deste modelo agora.": "当前无法加载此型号的客户数据。",
  "Principais clientes": "主要客户",
  "Até 8 clientes no ranking": "排行榜最多显示 8 位客户",
  "Volume comprado": "购买量",
  "Peças compradas pelos clientes exibidos": "当前客户购买的件数",
  "Média mensal conjunta": "合计月均购买量",
  "Peças por mês no histórico recente": "近期历史中的每月件数",
  "Compra mais recente": "最近一次购买",
  "Total comprado": "累计购买",
  "Média mensal": "月均购买",
  "Última compra": "最近购买",
  Vendedora: "销售人员",
  "Sem vendedora": "未分配销售",
  "Ainda não há clientes com compras registradas para este modelo.": "此型号还没有客户购买记录。",
...
const translationRules: TranslationRule[] = [
  {
    pattern: /^Clientes que mais compram (.+)$/,
    replace: (_, model) => `购买 ${model} 最多的客户`,
  },
  {
    pattern: /^peças\/mês · base (\d+)m$/,
    replace: (_, months) => `件/月 · 基于 ${months} 个月`,
  },
  {
    pattern: /^Carregando (.+)\.\.\.$/,
