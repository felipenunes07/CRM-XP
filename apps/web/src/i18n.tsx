...
const extraExactTranslations: Record<string, string> = {
  ...
  "Estoque de telas": "屏幕库存",
  "Veja a quantidade disponível de cada tela e filtre rapidamente por marca, modelo ou qualidade.": "查看每种屏幕的可用数量，并按品牌、型号或品质快速筛选。",
  Telas: "屏幕",
  "Resumo das telas": "屏幕库存概览",
  "Quantidade total disponível": "当前可用总数",
  "Modelos com saldo": "有库存的型号",
  "Telas disponíveis para venda": "可销售的屏幕",
  "Marcas no catálogo": "目录中的品牌",
  "Use o filtro para encontrar rápido": "使用筛选快速查找",
  "Carregando telas da planilha...": "正在加载表格中的屏幕库存...",
  "Não foi possível carregar as telas agora. Tente atualizar a página.": "暂时无法加载屏幕库存，请刷新页面后重试。",
  "Buscar tela": "搜索屏幕",
  "Digite o modelo ou SKU": "输入型号或 SKU",
  "Todas as marcas": "所有品牌",
  "Todas as qualidades": "所有品质",
  Ordenar: "排序",
  "Maior estoque primeiro": "库存从高到低",
  "Menor estoque primeiro": "库存从低到高",
  "Modelo de A a Z": "型号 A 到 Z",
  "Mostrar somente telas com estoque": "仅显示有库存的屏幕",
  "Limpar filtros": "清除筛选",
  "Estoque atual": "当前库存",
  "Quantidade por tela": "各屏幕库存数量",
  "Dados da última leitura da planilha diária.": "数据来自每日表格的最新读取。",
  Tela: "屏幕",
  Família: "系列",
  "SKUs com saldo": "有库存的 SKU",
  Quantidade: "数量",
  "Ver detalhes": "查看详情",
  peças: "件",
  resultados: "个结果",
  "Nenhuma tela corresponde aos filtros selecionados.": "没有符合当前筛选条件的屏幕。",
