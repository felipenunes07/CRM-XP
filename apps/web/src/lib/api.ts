...
export const api = {
  ...
  setTaskHiddenPeople(token: string, hiddenPeople: string[]) {
    return request<{ saved: boolean }>("/api/tasks/people/visibility", { method: "POST", body: JSON.stringify({ hiddenPeople }) }, token);
  },
