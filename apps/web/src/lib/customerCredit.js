export function customerCreditRiskLabel(value) {
    if (value === "CRITICO")
        return "Crítico";
    if (value === "ATENCAO")
        return "Atenção";
...
export function customerCreditRiskClassName(value) {
    if (value === "CRITICO")
        return "credit-badge-danger";
    if (value === "ATENCAO")
        return "credit-badge-warning";
    if (value === "MONITORAR")
        return "credit-badge-monitor";
    return "credit-badge-ok";
}
export function customerCreditStateLabel(value) {
    if (value === "OWES")
        return "Devendo";
    if (value === "HAS_CREDIT_BALANCE")
        return "Saldo a favor";
    if (value === "UNUSED_CREDIT")
        return "Crédito sem uso";
    if (value === "OVER_CREDIT")
        return "Ultrapassou crédito";
    return "Quitado";
}
export function customerCreditStateClassName(value) {
    if (value === "OWES")
        return "credit-badge-warning";
    if (value === "HAS_CREDIT_BALANCE")
...
export function isOverdueCreditRow(row) {
    return row.hasOverduePayment || row.hasSeverelyOverduePayment || row.hasNoPayment;
}
export function customerCreditPrimaryLabel(row) {
    if (row.debtAmount > 0) {
        return "Em aberto";
    }
...
export function customerCreditHeadlineLabel(row) {
...
export function customerCreditHeadlineClassName(row) {
    if (row.operationalState === "OVER_CREDIT") {
        return "credit-badge-danger";
    }
    if (row.debtAmount > 0) {
...
export function customerCreditVisibleFlags(row) {
