...
import { formatCurrency, calculateDaysSince, formatDate, formatDateTime, formatDaysSince, formatPercent, formatNumber, statusLabel, } from "../lib/format";
...
export function CustomerDetailPage() {
    ...
    const creditDaysSinceLastPayment = creditRow?.daysSinceLastPayment ?? calculateDaysSince(creditRow?.lastPaymentDate ?? null);
