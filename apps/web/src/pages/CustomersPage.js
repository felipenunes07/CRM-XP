...
export function CustomersPage() {
    ...
    const filteredAvailableCreditAmount = useMemo(() => filteredLinkedCreditRows.reduce((sum, row) => sum + Math.max(0, row.availableCreditAmount ?? 0), 0), [filteredLinkedCreditRows]);
