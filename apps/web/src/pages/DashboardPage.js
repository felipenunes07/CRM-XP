...
function TrendTooltip({ active, payload, label, }) {
    ...
    return (_jsxs("div", {
        className: "chart-tooltip trend-tooltip", children: [_jsx("strong", { children: formatTrendTooltipLabel(label) }), point ? (_jsxs("div", { className: "chart-tooltip-count", children: [_jsx("strong", { children: formatNumber(point.totalCustomers) }), _jsx("span", { children: "clientes na base nesse dia" })] })) : null, _jsx("div", {
...
export function DashboardPage() {
    ...
    return (_jsxs("div", {
        className: "page-stack", children: [_jsxs("section", { className: "dashboard-hero-premium", children: [_jsx("div", { className: "hero-premium-bg", children: _jsx("div", { className: "hero-premium-gradient" }) }), _jsxs("div", { className: "hero-premium-content", children: [_jsxs("div", { className: "hero-premium-copy", children: [_jsx("div", { className: "premium-badge", children: "Operacao comercial" }), _jsx("h2", { className: "premium-title", children: "Prioridades de contato e saude da carteira de clientes" }), _jsx("p", { className: "premium-subtitle", children: "Use esta tela para decidir quem puxar agora, acompanhar faixas de risco e manter a base atualizada." }), _jsxs("div", { className: "premium-actions", children: [_jsx(Link, { className: "premium-button primary", to: "/agenda", children: "Abrir agenda do dia" }), _jsx("button", { className: "premium-button ghost", type: "button", disabled: isSyncing, onClick: handleSync, children: isSyncing ? "Sincronizando..." : "Sincronizar Agora" })] })] }), _jsxs("div", { className: "hero-premium-stats", children: [_jsxs("div", { className: "premium-stat-card", children: [_jsx("div", { className: "premium-stat-icon", children: _jsx("svg", { width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: _jsx("path", { d: "M12 8V12L15 15M21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12Z", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }) }) }), _jsxs("div", { className: "premium-stat-info", children: [_jsx("span", { children: "Ultima sincronizacao" }), _jsx("strong", { children: metrics.lastSyncAt ? new Date(metrics.lastSyncAt).toLocaleString("pt-BR") : "Pendente..." })] })] }), _jsxs("div", { className: "premium-stat-card interactive", onClick: handleSetTarget, title: "Clique para editar a meta", children: [_jsx("div", { className: `premium-stat-icon ${isTargetHit ? 'accent-success' : 'accent-blue'}`, children: _jsx("svg", { width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: _jsx("path", { d: "M12 2L15.09 8.26L22 9.27L17 14.14L18.18 21.02L12 17.77L5.82 21.02L7 14.14L2 9.27L8.91 8.26L12 2Z", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }) }) }), _jsxs("div", { className: "premium-stat-info", children: [_jsx("div", { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'center' }, children: _jsx("span", { children: "Meta do mes" }) }), _jsxs("div", { style: { display: 'flex', flexDirection: 'column', gap: '2px' }, children: [_jsxs("strong", { children: [formatNumber(itemsSold), " / ", targetAmount > 0 ? formatNumber(targetAmount) : 'Definir'] }), targetAmount > 0 && (_jsx("div", { style: { width: '100%', height: '4px', background: 'rgba(255,255,255,0.1)', borderRadius: '2px', overflow: 'hidden', marginTop: '2px' }, children: _jsx("div", { style: { width: `${Math.min(100, targetPercent)}%`, height: '100%', background: isTargetHit ? '#10b981' : '#3b82f6', transition: 'width 0.3s ease' } }) }))] })] })] }), _jsxs("div", { className: "premium-stat-card", children: [_jsx("div", { className: "premium-stat-icon accent-purple", children: _jsx("svg", { width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: _jsx("path", { d: "M12 8V12L15 15M21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12Z", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }) }) }), _jsxs("div", { className: "premium-stat-info", children: [_jsx("span", { children: "Tempo medio de compra" }), _jsxs("strong", { children: [metrics.averageFrequencyDays.toFixed(1), " ", _jsx("small", { children: "dias" })] })] })] })] })] })] }), _jsxs("section", {
            className: "stats-grid", children: [_jsx(StatCard, { title: "Total de clientes", value: formatNumber(metrics.totalCustomers), helper: "Base comercial consolidada" }), _jsx(StatCard, { title: "Clientes ativos", value: formatNumber(metrics.statusCounts.ACTIVE), badge: formatShare(metrics.statusCounts.ACTIVE, metrics.totalCustomers), helper: "Clientes dentro da zona ativa", tone: "success" }), _jsx(StatCard, { title: "Clientes em atencao", value: formatNumber(metrics.statusCounts.ATTENTION), badge: formatShare(metrics.statusCounts.ATTENTION, metrics.totalCustomers), helper: "Clientes pedindo monitoramento", tone: "warning" }), _jsx(StatCard, { title: "Clientes inativos", value: formatNumber(metrics.statusCounts.INACTIVE), badge: formatShare(metrics.statusCounts.INACTIVE, metrics.totalCustomers), helper: "Clientes fora da zona ativa", tone: "danger" }), _jsxs("article", {
                className: monthlyGoalCardClassName, children: [_jsxs("div", { className: "monthly-goal-card__header", children: [_jsxs("div", { className: "monthly-goal-card__copy", children: [_jsx("p", { className: "monthly-goal-card__eyebrow", children: "Meta mensal" }), _jsx("strong", { className: "monthly-goal-card__value", children: targetAmount > 0 ? `${formatNumber(itemsSold)} telas` : "Sem meta" }), _jsxs("div", { className: "monthly-goal-card__meta-row", children: [_jsxs("span", { className: "monthly-goal-card__pill", children: [_jsx("span", { className: "monthly-goal-card__pill-dot" }), monthlyGoalMetaLabel] }), _jsx("span", { className: "monthly-goal-card__highlight", children: monthlyGoalHighlight })] })] }), _jsxs("div", { className: "monthly-goal-card__progress", "aria-hidden": "true", children: [_jsxs("svg", { className: "monthly-goal-card__progress-ring", width: "72", height: "72", viewBox: "0 0 72 72", children: [_jsx("circle", { cx: "36", cy: "36", r: progressRadius, className: "monthly-goal-card__progress-track" }), _jsx("circle", { cx: "36", cy: "36", r: progressRadius, className: "monthly-goal-card__progress-fill", strokeDasharray: progressCircumference, strokeDashoffset: progressCircumference - (targetProgress / 100) * progressCircumference })] }), _jsx("div", { className: "monthly-goal-card__progress-core" }), _jsxs("div", { className: "monthly-goal-card__progress-label", children: [_jsx("strong", { children: targetAmount > 0 ? `${targetPercent}%` : "--" }), _jsx("span", { children: "meta" })] })] })] }), _jsx("span", {
                    className: [
                        ...
                        .filter(Boolean)
                        .join(" "), children: monthlyGoalStatus
                })]
            })]
        }), _jsxs("section", {
            className: "grid-two dashboard-grid", children: [_jsxs("article", {
                className: "panel chart-panel", children: [_jsx("div", { className: "panel-header", children: _jsxs("div", { children: [_jsx("p", { className: "eyebrow", children: activeChartCopy.eyebrow }), chartView === "inactivity" ? (_jsxs("h3", { className: "header-with-info", children: [activeChartCopy.title, _jsx(InfoHint, { text: "As barras mostram dias sem compra. Regra de status atual: Ativo ate 30 dias, Atencao de 31 a 89 dias e Inativo a partir de 90 dias." })] })) : (_jsx("h3", { children: activeChartCopy.title }))] }) }), _jsx("p", { className: "panel-subcopy", children: chartDescription }), _jsx("div", { className: "chart-switcher", role: "tablist", "aria-label": "Alternar visualizacao dos graficos do dashboard", children: Object.entries(chartViewCopy).map(([view, copy]) => (_jsxs("button", { type: "button", role: "tab", "aria-selected": chartView === view, "aria-pressed": chartView === view, className: `chart-switch-button ${chartView === view ? "active" : ""}`, onClick: () => handleChangeChartView(view), children: [_jsx("strong", { children: copy.toggleLabel }), _jsx("span", { children: copy.toggleHelper })] }, view))) }), chartView === "inactivity" ? (_jsxs(_Fragment, {
                    children: [_jsxs("div", { className: "status-guide-grid", children: [_jsxs("div", { className: "status-guide-card is-active", children: [_jsx("strong", { children: "Ativo" }), _jsx("span", { children: "Ate 30 dias sem comprar" })] }), _jsxs("div", { className: "status-guide-card is-attention", children: [_jsx("strong", { children: "Atencao" }), _jsx("span", { children: "De 31 a 89 dias sem comprar" })] }), _jsxs("div", { className: "status-guide-card is-inactive", children: [_jsx("strong", { children: "Inativo" }), _jsx("span", { children: "90 dias ou mais sem comprar" })] })] }), _jsx("div", {
                        className: "chart-wrap", children: _jsx(ResponsiveContainer, {
                            width: "100%", height: 280, children: _jsxs(BarChart, {
                                data: metrics.inactivityBuckets, onClick: (state) => {
            ...
            }), tableQueryLoading ? _jsx("div", { className: "page-loading", children: "Carregando clientes priorizados..." }) : null, tableQueryError ? _jsx("div", { className: "page-error", children: "Nao foi possivel carregar essa lista de clientes." }) : null, !tableQueryLoading && !tableQueryError ? _jsx(CustomerTable, { customers: tableCustomers }) : null]
        })]
    }));
}
