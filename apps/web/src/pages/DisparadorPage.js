...
export function DisparadorPage() {
    ...
    return (_jsxs("div", { className: "page-stack", children: [_jsxs("section", { className: "panel whatsapp-workspace-header", children: [_jsxs("div", { className: "whatsapp-workspace-copy", children: [_jsx("p", { className: "eyebrow", children: "Disparador WhatsApp" }), _jsx("h2", { children: "Disparador" }), _jsx("p", { className: "panel-subcopy", children: "Monte a mensagem, confira a base e acompanhe a fila sem sair desta tela." }), _jsxs("div", { className: "whatsapp-flow-strip", children: [_jsxs("div", { className: `whatsapp-flow-step ${hasMessage ? "is-done" : "is-active"}`, children: [_jsx("span", { children: "1" }), _jsxs("div", { children: [_jsx("strong", { children: "Monte a mensagem" }), _jsx("small", { children: "Defina campanha, template e texto final." })] })] }), _jsxs("div", { className: `whatsapp-flow-step ${mappingSummaryQuery.data?.totalGroups ? "is-done" : ""}`, children: [_jsx("span", { children: "2" }), _jsxs("div", { children: [_jsx("strong", { children: "Confira a base" }), _jsx("small", { children: "Atualize a planilha e veja pendencias antes do envio." })] })] }), _jsxs("div", { className: `whatsapp-flow-step ${isReadyToDispatch ? "is-done" : ""}`, children: [_jsx("span", { children: "3" }), _jsxs("div", { children: [_jsx("strong", { children: "Dispare com seguranca" }), _jsx("small", { children: "Selecione os grupos e acompanhe a fila em tempo real." })] })] })] })] }), _jsxs("div", { className: "whatsapp-inline-stats", children: [_jsxs("div", { className: "whatsapp-inline-stat is-highlight", children: [_jsx("span", { children: "Selecionados" }), _jsx("strong", { children: formatNumber(selectedGroupCount) })] }), _jsxs("div", { className: "whatsapp-inline-stat", children: [_jsx("span", { children: "Base" }), _jsx("strong", { children: mappingSummaryQuery.data ? formatNumber(mappingSummaryQuery.data.totalGroups) : "--" })] }), _jsxs("div", { className: "whatsapp-inline-stat", children: [_jsx("span", { children: "Pendentes" }), _jsx("strong", { children: mappingSummaryQuery.data ? formatNumber(mappingSummaryQuery.data.pendingReviewGroups) : "--" })] }), _jsxs("div", { className: "whatsapp-inline-stat", children: [_jsx("span", { children: "Ultima atualizacao" }), _jsx("strong", { children: formatDateTime(mappingSummaryQuery.data?.lastImportedAt ?? null) })] })] })] }), _jsxs("section", { className: "grid-two whatsapp-simple-grid whatsapp-setup-grid", children: [_jsxs("article", { className: "panel whatsapp-compose-panel", children: [_jsxs("div", { className: "panel-header", children: [_jsxs("div", { children: [_jsx("p", { className: "eyebrow", children: "Passo 1" }), _jsx("h3", { children: "Mensagem e disparo" }), _jsx("p", { className: "panel-subcopy", children: "Preencha da esquerda para a direita: campanha, ritmo e mensagem final." })] }), _jsxs("div", { className: `whatsapp-panel-pill ${isReadyToDispatch ? "is-ready" : ""}`, children: [_jsx("strong", { children: isReadyToDispatch ? "Pronto para disparar" : "Em preparacao" }), _jsx("span", { children: composeHelperText })] })] }), _jsxs("div", { className: "whatsapp-compose-summary", children: [_jsxs("div", { children: [_jsx("span", { children: "Template" }), _jsx("strong", { children: selectedTemplate?.title ?? "Mensagem livre" })] }), _jsxs("div", { children: [_jsx("span", { children: "Publico salvo" }), _jsx("strong", { children: selectedSavedSegment?.name ?? "Todos os grupos" })] }), _jsxs("div", { children: [_jsx("span", { children: "Selecionados" }), _jsxs("strong", { children: [formatNumber(selectedGroupCount), " grupos"] })] }), _jsxs("div", { children: [_jsx("span", { children: "Anti-spam" }), _jsx("strong", { children: overrideRecentBlock ? "Bloqueio ignorado" : "Bloqueio de 7 dias ativo" })] })] }), _jsxs("div", { className: "filters-grid whatsapp-compose-top-grid", children: [_jsxs("label", { children: ["Nome da campanha", _jsx("input", { value: campaignName, onChange: (event) => setCampaignName(event.target.value), placeholder: "Ex: Reativacao clientes inativos" })] }), _jsxs("label", { children: ["Template de mensagem", _jsxs("select", { value: selectedTemplateId, onChange: (event) => setSelectedTemplateId(event.target.value), children: [_jsx("option", { value: "", children: "Mensagem livre" }), (templatesQuery.data ?? []).map((template) => (_jsx("option", { value: template.id, children: template.title }, template.id)))] })] })] }), _jsxs("div", { className: "whatsapp-delay-grid", children: [_jsxs("label", { className: "whatsapp-delay-field", children: [_jsx("span", { children: "Delay minimo" }), _jsx("input", { type: "number", min: 1, value: minDelaySeconds, onChange: (event) => setMinDelaySeconds(Number(event.target.value) || 1) }), _jsx("small", { children: "Menor intervalo entre um envio e outro." })] }), _jsxs("label", { className: "whatsapp-delay-field", children: [_jsx("span", { children: "Delay maximo" }), _jsx("input", { type: "number", min: 1, value: maxDelaySeconds, onChange: (event) => setMaxDelaySeconds(Number(event.target.value) || 1) }), _jsx("small", { children: "Ajuda a distribuir a fila com variacao natural." })] })] }), _jsxs("div", { className: "whatsapp-compose-editor-grid", children: [_jsxs("label", { className: "whatsapp-message-field", children: [_jsx("span", { children: "Mensagem final" }), _jsx("textarea", { rows: 12, value: messageText, onChange: (event) => setMessageText(event.target.value), placeholder: "Digite a mensagem que sera enviada..." })] }), _jsxs("div", { className: "whatsapp-preview-panel", children: [_jsxs("div", { className: "whatsapp-preview-header", children: [_jsx("strong", { children: "Previa do envio" }), _jsx("span", { children: "Assim o texto aparece antes do disparo." })] }), _jsx("div", { className: "message-preview whatsapp-message-preview whatsapp-message-preview-panel", children: messageText || "A mensagem final vai aparecer aqui assim que voce escrever ou escolher um template." })] })] }), !templatesQuery.data?.length ? (_jsx("div", { className: "empty-state", children: "Nenhum template salvo ainda. A mensagem livre abaixo sera usada normalmente." })) : null, _jsxs("div", { className: "whatsapp-compose-footer", children: [_jsxs("label", { className: "whatsapp-checkbox-row", children: [_jsx("input", { type: "checkbox", checked: overrideRecentBlock, onChange: (event) => setOverrideRecentBlock(event.target.checked) }), _jsx("span", { children: "Ignorar o bloqueio de 7 dias para contatos recentes" })] }), _jsxs("div", { className: "whatsapp-compose-actions", children: [_jsx("p", { className: "panel-subcopy", children: composeHelperText }), _jsxs("button", { className: "primary-button", type: "button", onClick: () => createCampaignMutation.mutate(), disabled: createCampaignMutation.isPending || !isReadyToDispatch, children: [createCampaignMutation.isPending ? _jsx(LoaderCircle, { size: 16, className: "spin" }) : _jsx(Send, { size: 16 }), dispatchButtonLabel] })] })] }), createCampaignMutation.isError ? (_jsx("div", { className: "page-error", children: createCampaignMutation.error.message })) : null] }), _jsxs("article", { className: "panel whatsapp-source-panel", children: [_jsx("div", { className: "panel-header", children: _jsxs("div", { children: [_jsx("p", { className: "eyebrow", children: "Passo 2" }), _jsx("h3", { children: "Base de grupos" }), _jsx("p", { className: "panel-subcopy", children: "A planilha padrao do desktop alimenta a tela. Atualize so quando quiser recarregar." })] }) }), _jsxs("div", { className: "whatsapp-base-overview", children: [_jsxs("div", { children: [_jsx("span", { children: "Base total" }), _jsx("strong", { children: mappingSummaryQuery.data ? formatNumber(mappingSummaryQuery.data.totalGroups) : "--" })] }), _jsxs("div", { children: [_jsx("span", { children: "Nunca compraram" }), _jsx("strong", { children: mappingSummaryQuery.data
                                                    ? formatNumber(mappingSummaryQuery.data.classificationCounts.NO_ORDER_EXCEL)
                                                    : "--" })] }), _jsxs("div", { children: [_jsx("span", { children: "Ultima atualizacao" }), _jsx("strong", { children: formatDateTime(mappingSummaryQuery.data?.lastImportedAt ?? null) })] })] }), _jsxs("div", { className: "whatsapp-source-actions", children: [canImport ? (_jsxs("button", { className: "primary-button", type: "button", onClick: () => importDefaultMutation.mutate(), disabled: isImporting, children: [isImporting ? _jsx(LoaderCircle, { size: 16, className: "spin" }) : _jsx(RefreshCw, { size: 16 }), isImporting ? "Atualizando..." : "Usar planilha padrao"] })) : null, canImport ? (_jsxs("label", { className: "whatsapp-file-input", children: [_jsx(UploadCloud, { size: 16 }), _jsx("span", { children: selectedFile ? selectedFile.name : "Escolher outro arquivo" }), _jsx("input", { type: "file", accept: ".xlsx,.xls", onChange: handleFileChange })] })) : null, canImport && selectedFile ? (_jsx("button", { className: "ghost-button", type: "button", onClick: () => importFileMutation.mutate(), disabled: isImporting, children: "Importar arquivo escolhido" })) : null] }), importSummary ? (_jsxs("div", { className: "whatsapp-summary-grid", children: [_jsxs("div", { children: [_jsx("span", { children: "Linhas validas" }), _jsx("strong", { children: formatNumber(importSummary.importedCount) })] }), _jsxs("div", { children: [_jsx("span", { children: "Inseridos" }), _jsx("strong", { children: formatNumber(importSummary.insertedCount) })] }), _jsxs("div", { children: [_jsx("span", { children: "Atualizados" }), _jsx("strong", { children: formatNumber(importSummary.updatedCount) })] }), _jsxs("div", { children: [_jsx("span", { children: "Auto mapeados" }), _jsx("strong", { children: formatNumber(importSummary.autoMappedCount) })] })] })) : null, importError ? _jsx("div", { className: "page-error", children: importError.message }) : null, mappingSummaryQuery.data?.pendingReviewGroups ? (_jsxs("div", { className: "whatsapp-inline-note", children: [_jsxs("strong", { children: [formatNumber(mappingSummaryQuery.data.pendingReviewGroups), " pendentes."] }), _jsx("span", { children: "Continuam na tabela, mas nao entram em publico salvo ate fechar o mapeamento." })] })) : null, liveCampaign && liveCampaignIsRunning ? (_jsxs("div", { className: "whatsapp-live-card whatsapp-live-queue-card", children: [_jsxs("div", { className: "whatsapp-live-card-header", children: [_jsx("strong", { children: "Fila do disparo agora" }), _jsx("span", { className: `status-badge status-${campaignStatusTone(liveCampaign.status)}`, children: liveCampaign.status })] }), _jsxs("div", { className: "whatsapp-live-card-grid", children: [_jsxs("div", { children: [_jsx("span", { children: "Campanha" }), _jsx("strong", { children: liveCampaign.name })] }), _jsxs("div", { children: [_jsx("span", { children: "Proximo envio" }), _jsx("strong", { children: formatDateTime(liveCampaign.progress.nextScheduledAt) })] }), _jsxs("div", { children: [_jsx("span", { children: "Enviados" }), _jsx("strong", { children: formatNumber(liveCampaign.progress.sentCount) })] }), _jsxs("div", { children: [_jsx("span", { children: "Pendentes" }), _jsx("strong", { children: formatNumber(liveCampaign.progress.pendingCount) })] })] }), _jsxs("div", { className: "whatsapp-countdown-card", children: [_jsx("span", { children: "Proximo disparo em" }), _jsx("strong", { children: liveCampaign.progress.nextScheduledAt
