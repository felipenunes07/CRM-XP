...
import { CheckCircle2, Clock3, LoaderCircle, Send, ShieldAlert, Plus, ArrowRight, Check, Trash2, Info, Users, Smartphone, PlusCircle, Sparkles, ChevronRight, ChevronLeft, ClipboardList, Save, X, CheckCheck, Smile, Paperclip } from "lucide-react";
...
export function DisparadorPage() {
    ...
    const [campaignMessageType, setCampaignMessageType] = useState("TEXT");
    ...
    return (_jsxs("div", { className: "page-stack", children: [_jsxs("div", { className: "z-tabs", style: { marginBottom: "1.5rem" }, children: [_jsxs("button", { type: "button", className: `z-tab ${activeTab === "NEW_CAMPAIGN" ? "active" : ""}`, onClick: () => setActiveTab("NEW_CAMPAIGN"), children: [_jsx(Plus, { size: 16 }), "Nova Campanha"] }), _jsxs("button", { type: "button", className: `z-tab ${activeTab === "HISTORY" ? "active" : ""}`, onClick: () => setActiveTab("HISTORY"), children: [_jsx(Clock3, { size: 16 }), "Hist\u00F3rico de Campanhas"] })] }), activeTab === "NEW_CAMPAIGN" && (_jsxs(_Fragment, { children: [_jsxs("div", { className: "wp-stepper", children: [_jsxs("button", { type: "button", className: `wp-step ${currentStep === 1 ? "active" : ""} ${currentStep > 1 ? "completed" : ""}`, onClick: () => setCurrentStep(1), children: [_jsx("span", { className: "wp-step-num", children: currentStep > 1 ? _jsx(Check, { size: 14 }) : "1" }), _jsx("span", { children: "Cria\u00E7\u00E3o" })] }), _jsx("span", { className: "wp-step-arrow", children: _jsx(ChevronRight, { size: 14 }) }), _jsxs("button", { type: "button", className: `wp-step ${currentStep === 2 ? "active" : ""} ${currentStep > 2 ? "completed" : ""}`, onClick: () => setCurrentStep(2), children: [_jsx("span", { className: "wp-step-num", children: currentStep > 2 ? _jsx(Check, { size: 14 }) : "2" }), _jsx("span", { children: "Remetentes" })] }), _jsx("span", { className: "wp-step-arrow", children: _jsx(ChevronRight, { size: 14 }) }), _jsxs("button", { type: "button", className: `wp-step ${currentStep === 3 ? "active" : ""} ${currentStep > 3 ? "completed" : ""}`, onClick: () => setCurrentStep(3), children: [_jsx("span", { className: "wp-step-num", children: currentStep > 3 ? _jsx(Check, { size: 14 }) : "3" }), _jsx("span", { children: "Destinat\u00E1rios" })] }), _jsx("span", { className: "wp-step-arrow", children: _jsx(ChevronRight, { size: 14 }) }), _jsxs("button", { type: "button", className: `wp-step ${currentStep === 4 ? "active" : ""} ${currentStep > 4 ? "completed" : ""}`, onClick: () => setCurrentStep(4), children: [_jsx("span", { className: "wp-step-num", children: currentStep > 4 ? _jsx(Check, { size: 14 }) : "4" }), _jsx("span", { children: "Mensagem" })] }), _jsx("span", { className: "wp-step-arrow", children: _jsx(ChevronRight, { size: 14 }) }), _jsxs("button", { type: "button", className: `wp-step ${currentStep === 5 ? "active" : ""} ${currentStep > 5 ? "completed" : ""}`, onClick: () => setCurrentStep(5), children: [_jsx("span", { className: "wp-step-num", children: "5" }), _jsx("span", { children: "Revis\u00E3o" })] }), _jsx("div", { className: "wp-stepper-progress", style: { width: `${((currentStep - 1) / 4) * 100}%` } })] }), _jsx("div", { className: "wp-wizard-layout full-width", children: _jsxs("div", { className: "wp-wizard-main", children: [currentStep === 1 && (_jsxs("div", { className: "wp-card-step", children: [_jsx("div", { className: "wp-card-step-badge", children: "01" }), _jsx("div", { className: "wp-card-step-header", children: _jsx("h3", { className: "wp-card-step-title", children: "Cria\u00E7\u00E3o" }) }), _jsxs("div", { style: { display: "flex", flexDirection: "column", gap: "12px", marginTop: "0.5rem" }, children: [_jsxs("label", { style: { display: "flex", alignItems: "center", gap: "8px", fontSize: "0.95rem", fontWeight: 700, color: "#18181b" }, children: [_jsx(PlusCircle, { size: 18, style: { color: "#10b981" } }), "Digite o t\u00EDtulo da sua campanha"] }), _jsx("div", { className: "wp-card-input-container", children: _jsx("input", { value: campaignName, onChange: (event) => setCampaignName(event.target.value), placeholder: "Digite o nome da campanha...", className: "wp-card-input" }) })] }), canImport && (_jsxs("div", { style: { display: "flex", flexDirection: "column", gap: "1rem", background: "#f8fafc", padding: "1.25rem", borderRadius: "12px", border: "1px solid #e2e8f0", marginTop: "0.5rem" }, children: [_jsx("h4", { style: { margin: 0, fontSize: "0.85rem", fontWeight: 700, color: "#475569", textTransform: "uppercase", letterSpacing: "0.05em" }, children: "Configura\u00E7\u00F5es Anti-Spam (Recomendado)" }), _jsxs("div", { className: "whatsapp-delay-grid", style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem" }, children: [_jsxs("div", { className: "whatsapp-delay-field", style: { display: "flex", flexDirection: "column", gap: "6px" }, children: [_jsx("span", { style: { fontSize: "0.8rem", fontWeight: 600, color: "#475569" }, children: "Delay m\u00EDnimo (segundos)" }), _jsx("input", { type: "number", min: 1, value: minDelaySeconds, onChange: (event) => setMinDelaySeconds(Number(event.target.value) || 1), className: "wp-card-input", style: { padding: "0.5rem 0.75rem", fontSize: "0.9rem" } })] }), _jsxs("div", { className: "whatsapp-delay-field", style: { display: "flex", flexDirection: "column", gap: "6px" }, children: [_jsx("span", { style: { fontSize: "0.8rem", fontWeight: 600, color: "#475569" }, children: "Delay m\u00E1ximo (segundos)" }), _jsx("input", { type: "number", min: 1, value: maxDelaySeconds, onChange: (event) => setMaxDelaySeconds(Number(event.target.value) || 1), className: "wp-card-input", style: { padding: "0.5rem 0.75rem", fontSize: "0.9rem" } })] })] }), _jsx("div", { style: { borderTop: "1px solid #e2e8f0", paddingTop: "1rem", marginTop: "0.5rem" }, children: _jsxs("div", { style: {
                                                ...
                                                boxShadow: "0 4px 12px rgba(0,0,0,0.03)"
                                                                ...
                                                                if (!createSavedSegmentMutation.isPending && newSegmentName.trim() && pastedClsText.trim()) {
                                                                    ...
                                                                    return (_jsxs("tr", { style: {
                                                                        ...
                                                                        transition: "all 0.2s"
                                                                    }, children: ["Pr\u00F3ximo", _jsx(ChevronRight, { size: 16 })] })] }))] })] })) : (_jsx("div", { className: "empty-panel", style: { padding: "3rem 1rem" }, children: _jsx("div", { className: "empty-state", children: "Nenhum destinat\u00E1rio encontrado com os filtros atuais." }) }))] })), currentStep === 4 && (_jsxs("article", { className: "panel", children: [_jsx("div", { className: "panel-header", children: _jsxs("div", { children: [_jsx("h3", { children: "Conte\u00FAdo do Envio" }), _jsx("p", { className: "panel-subcopy", children: "Escolha ou crie a mensagem e confira o visual no simulador do smartphone." })] }) }), _jsxs("div", { className: "whatsapp-compose-editor-grid", style: { display: "grid", gridTemplateColumns: "1fr 280px", gap: "1.5rem" }, children: [_jsxs("div", { style: { display: "flex", flexDirection: "column", gap: "1rem" }, children: [_jsxs("label", { children: ["Template de mensagem", _jsxs("select", { value: selectedTemplateId, onChange: (event) => setSelectedTemplateId(event.target.value), className: "wp-search-input", style: { paddingLeft: "12px", background: "#fff" }, children: [_jsx("option", { value: "", children: "Mensagem livre" }), (templatesQuery.data ?? []).map((template) => (_jsx("option", { value: template.id, children: template.title }, template.id)))] })] }), selectedSenderProvider === "UAZAPI" ? (_jsxs("div", { style: { display: "flex", gap: "0.5rem", alignItems: "center" }, children: [_jsx("span", { style: { fontSize: "0.82rem", fontWeight: 600, color: "var(--muted)" }, children: "Tipo de envio:" }), _jsx("button", { type: "button", className: `ghost-button${campaignMessageType === "TEXT" ? " active" : ""}`, style: { padding: "6px 14px", borderRadius: "8px", fontSize: "0.82rem", fontWeight: 600, background: campaignMessageType === "TEXT" ? "var(--accent)" : "var(--bg-soft)", color: campaignMessageType === "TEXT" ? "#fff" : "var(--muted)", border: "1px solid var(--line)" }, onClick: () => setCampaignMessageType("TEXT"), children: "Texto" }), _jsx("button", { type: "button", className: `ghost-button${campaignMessageType === "CAROUSEL" ? " active" : ""}`, style: { padding: "6px 14px", borderRadius: "8px", fontSize: "0.82rem", fontWeight: 600, background: campaignMessageType === "CAROUSEL" ? "var(--accent)" : "var(--bg-soft)", color: campaignMessageType === "CAROUSEL" ? "#fff" : "var(--muted)", border: "1px solid var(--line)" }, onClick: () => setCampaignMessageType("CAROUSEL"), children: "Carrossel" })] })) : (_jsxs("div", { style: {
                                                                ...
                                                                alignItems: "center",
                                                                gap: "8px"
                                                            }, children: [_jsx(Info, { size: 16 }), _jsxs("div", { children: [_jsx("strong", { children: "Carrossel indispon\u00EDvel:" }), " Selecione uma inst\u00E2ncia UazAPI no passo \"Remetentes\" para usar carross\u00E9is com imagens e bot\u00F5es."] })] })), _jsxs("label", { className: "whatsapp-message-field", children: [_jsxs("span", { children: ["Texto da Mensagem", campaignMessageType === "CAROUSEL" ? " (acompanha o carrossel)" : " (Versão A)"] }), _jsx("textarea", { rows: campaignMessageType === "CAROUSEL" ? 4 : 8, value: messageText, onChange: (event) => setMessageText(event.target.value), placeholder: "Digite a mensagem principal que ser\u00E1 enviada aos clientes..." })] }), campaignMessageType === "CAROUSEL" && (_jsxs("div", { style: { display: "flex", flexDirection: "column", gap: "1rem", padding: "1rem", background: "var(--bg-soft)", borderRadius: "12px", border: "1px solid var(--line)" }, children: [_jsxs("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center" }, children: [_jsx("span", { style: { fontWeight: 700, fontSize: "0.92rem", color: "#0f172a" }, children: "Slides do Carrossel" }), _jsxs("button", { type: "button", className: "ghost-button", style: { padding: "4px 10px", fontSize: "0.78rem", display: "flex", alignItems: "center", gap: "4px" }, onClick: () => setCarouselSlides(prev => [...prev, { text: "", image: "", buttons: [{ id: `btn${Date.now()}`, text: "", type: "url" }] }]), children: [_jsx(PlusCircle, { size: 14 }), " Adicionar Slide"] })] }), carouselSlides.map((slide, slideIdx) => (_jsxs("div", { style: { padding: "1rem", background: "#fff", borderRadius: "10px", border: "1px solid var(--line)", display: "flex", flexDirection: "column", gap: "0.75rem" }, children: [_jsxs("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center" }, children: [_jsxs("span", { style: { fontWeight: 600, fontSize: "0.85rem", color: "var(--accent)" }, children: ["Slide ", slideIdx + 1] }), carouselSlides.length > 1 && (_jsxs("button", { type: "button", className: "ghost-button danger", style: { padding: "2px 8px", fontSize: "0.72rem" }, onClick: () => setCarouselSlides(prev => prev.filter((_, i) => i !== slideIdx)), children: [_jsx(Trash2, { size: 12 }), " Remover"] }))] }), _jsxs("label", { style: { fontSize: "0.82rem" }, children: ["Texto do slide", _jsx("textarea", { rows: 2, value: slide.text, onChange: (e) => {
                                                                                        const updated = [...carouselSlides];
                                                                                        updated[slideIdx] = { ...slide, text: e.target.value };
                                                                                        setCarouselSlides(updated);
                                                                                    }, placeholder: "Texto que aparece neste slide...", style: { marginTop: "4px" } })] }), _jsxs("div", { style: { display: "flex", flexDirection: "column", gap: "0.5rem" }, children: [_jsxs("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center" }, children: [_jsx("span", { style: { fontSize: "0.82rem", fontWeight: 600, color: "#0f172a" }, children: "Imagem" }), _jsx("span", { style: {
                                                                                                fontSize: "0.7rem",
                                                                                                color: "#10b981",
                                                                                                background: "#f0fdf4",
                                                                                                padding: "2px 8px",
                                                                                            ...
                                                                                            }, children: "\uD83D\uDCD0 Ideal: 800x600px (4:3)" })] }), _jsx("div", { style: { display: "flex", gap: "0.5rem", alignItems: "center" }, children: _jsxs("label", { style: { flex: 1, cursor: "pointer" }, children: [_jsx("input", { type: "file", accept: "image/jpeg,image/jpg,image/png,image/gif,image/webp", style: { display: "none" }, onChange: (e) => {
                                                                                        ...
                                                                                        setCarouselSlides(updated);
                                                                                    }, placeholder: "https://exemplo.com/imagem.jpg", style: { fontSize: "0.82rem" }, disabled: uploadingSlideIndex === slideIdx }), _jsxs("div", { style: {
                                                                                        fontSize: "0.7rem",
                                                                                        color: "#64748b",
                                                                                        background: "#f8fafc",
                                                                                        padding: "8px 10px",
                                                                                        ...
                                                                                        flexDirection: "column",
                                                                                        gap: "4px"
                                                                                    }, children: [_jsxs("div", { style: { display: "flex", alignItems: "center", gap: "4px" }, children: [_jsx(Info, { size: 12 }), _jsx("strong", { children: "Dimens\u00F5es recomendadas:" })] }), _jsxs("div", { style: { paddingLeft: "16px" }, children: ["\u2022 ", _jsx("strong", { children: "Ideal:" }), " 800x600px (propor\u00E7\u00E3o 4:3)", _jsx("br", {}), "\u2022 ", _jsx("strong", { children: "M\u00EDnimo:" }), " 400x300px", _jsx("br", {}), "\u2022 ", _jsx("strong", { children: "M\u00E1ximo:" }), " 1920x1440px", _jsx("br", {}), "\u2022 ", _jsx("strong", { children: "Tamanho:" }), " at\u00E9 5MB"] })] }), slide.image && !slide.image.startsWith('data:') && (_jsxs("div", { style: { fontSize: "0.7rem", color: "#64748b", display: "flex", alignItems: "center", gap: "4px" }, children: [_jsx(Info, { size: 12 }), "URL externa"] })), slide.image && slide.image.startsWith('data:') && (_jsxs("div", { style: { fontSize: "0.7rem", color: "#10b981", display: "flex", alignItems: "center", gap: "4px", fontWeight: 600 }, children: [_jsx(CheckCircle2, { size: 12 }), "Imagem carregada (", formatFileSize(slide.image.length * 0.75), ")"] }))] }), slide.image && (_jsxs("div", { style: { position: "relative" }, children: [_jsx("img", { src: slide.image, alt: `Preview slide ${slideIdx + 1}`, style: {
                                                                                        width: "100%",
                                                                                        maxHeight: "200px",
                                                                                        objectFit: "cover",
                                                                                        borderRadius: "10px",
                                                                                        ...
                                                                                        e.currentTarget.style.transform = "scale(1)";
                                                                                                ...
                                                                                                setCarouselSlides(updated);
                                                                                            }, placeholder: "Texto do bot\u00E3o", style: { flex: 1, fontSize: "0.82rem" } }), slide.buttons.length > 1 && (_jsx("button", { type: "button", className: "ghost-button danger", style: { padding: "2px 6px", fontSize: "0.7rem" }, onClick: () => {
                                                                                                const updated = [...carouselSlides];
                                                                                                updated[slideIdx] = { ...slide, buttons: slide.buttons.filter((_, i) => i !== btnIdx) };
                                                                                                setCarouselSlides(updated);
                                                                                            }, children: _jsx(Trash2, { size: 11 }) }))] }, btn.id))), _jsx("button", { type: "button", className: "ghost-button", style: { padding: "3px 8px", fontSize: "0.72rem", alignSelf: "flex-start" }, onClick: () => {
                                                                                        const updated = [...carouselSlides];
                                                                    ...
                                                                    flexDirection: "column"
                                                                            ...
                                                                            backgroundSize: "100px 100px"
                                                                                        ...
                                                                                        wordWrap: "break-word"
                                                                                            ...
                                                                                            }, children: [slide.image && (_jsx("div", { style: {
                                                                                                        position: "relative",
                                                                                                        width: "100%",
                                                                                                        height: "120px",
                                                                                                        background: "#f0f0f0",
                                                                                                        overflow: "hidden"
                                                                                                    }, children: _jsx("img", { src: slide.image, alt: "", style: {
                                                                                                            width: "100%",
                                                                                                            height: "100%",
                                                                                                            objectFit: "cover",
                                                ...
                                                boxShadow: "0 4px 12px rgba(59, 130, 246, 0.15)"
                                            }, children: _jsxs("div", { style: { display: "flex", alignItems: "start", gap: "1rem" }, children: [_jsxs("div", { style: { flex: 1 }, children: [_jsxs("h4", { style: { margin: "0 0 8px 0", color: "#1e40af", fontSize: "1rem", display: "flex", alignItems: "center", gap: "8px", fontWeight: 700 }, children: [_jsx(Smartphone, { size: 18 }), "Enviar Mensagem de Teste"] }), _jsx("p", { style: { margin: "0 0 12px 0", fontSize: "0.85rem", color: "#1e40af", lineHeight: 1.5 }, children: "Antes de disparar para todos os destinat\u00E1rios, envie uma mensagem de teste para verificar se est\u00E1 tudo correto." }), _jsxs("div", { style: {
                                                                    ...
                                                                    gap: "8px",
                                                                    marginBottom: "12px"
                                                                }, children: [_jsx(Info, { size: 14 }), _jsxs("div", { children: [_jsx("strong", { children: "N\u00FAmero de teste:" }), " +55 11 91127-9702", campaignMessageType === "CAROUSEL" && (_jsx("div", { style: { marginTop: "4px", fontSize: "0.75rem" }, children: "\u26A0\uFE0F O carrossel ser\u00E1 enviado com todas as imagens e bot\u00F5es configurados" }))] })] })] }), _jsx("button", { type: "button", onClick: () => sendTestMessageMutation.mutate(), disabled: sendTestMessageMutation.isPending || (!hasMessage && campaignMessageType !== "CAROUSEL"), style: {
                                                            padding: "1rem 1.5rem",
