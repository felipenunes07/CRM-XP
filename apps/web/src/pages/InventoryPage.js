...
function InventoryTrendChart({ series }) {
    ...
    return (_jsxs("div", { className: "inventory-overview-chart-grid", children: [_jsxs("article", { className: "inventory-overview-chart-card", children: [_jsxs("div", { className: "inventory-overview-chart-header", children: [_jsxs("div", { children: [_jsx("span", { children: "Grafico 1" }), _jsx("h4", { children: "Pecas em estoque" })] }), _jsx("p", { children: "Mostra so a quantidade total da planilha em cada leitura do dia." })] }), stockSeries.length > 0 ? (_jsxs("div", { className: "trend-chart-wrap inventory-trend-chart", children: [_jsx(ResponsiveContainer, { width: "100%", height: 230, children: _jsxs(ComposedChart, { syncId: "inventory-overview", syncMethod: "value", data: stockSeries, children: [_jsx(CartesianGrid, { vertical: false, strokeDasharray: "3 3", stroke: "rgba(41, 86, 215, 0.12)" }), _jsx(XAxis, { dataKey: "date", tickFormatter: formatShortDate, tick: { fontSize: 12 } }), _jsx(YAxis, { tickFormatter: (value) => formatCompactNumber(Number(value)), tick: { fontSize: 12 } }), _jsx(Tooltip, { labelFormatter: (value) => formatDate(String(value)), formatter: (value, name) => [formatSeriesValue(String(name), Number(value ?? 0)), String(name)] }), _jsx(Area, { type: "monotone", dataKey: "totalStockUnitsTela", name: "Pecas Telas", stroke: "#2956d7", fill: "rgba(95, 140, 255, 0.18)", strokeWidth: 2.4, dot: stockSeries.length === 1 ? { r: 4, fill: "#2956d7" } : false, activeDot: { r: 6 } }), _jsx(Area, { type: "monotone", dataKey: "totalStockUnitsDoc", name: "Pecas DOCs", stroke: "#d09a29", fill: "rgba(208, 154, 41, 0.18)", strokeWidth: 2.4, dot: stockSeries.length === 1 ? { r: 4, fill: "#d09a29" } : false, activeDot: { r: 6 } })] }) }), _jsxs("div", { className: "inventory-chart-legend", children: [_jsxs("span", { children: [_jsx("i", { className: "tone-neutral", style: { backgroundColor: "#2956d7" } }), " Telas"] }), _jsxs("span", { children: [_jsx("i", { className: "tone-warning", style: { backgroundColor: "#d09a29" } }), " DOCs de Carga"] })] })] })) : (_jsx(InventoryChartEmptyState, { title: "Ainda nao da para ver a curva do estoque", description: firstSnapshotDate
...
export function InventoryPage() {
    ...
    const [staleFilter, setStaleFilter] = useState("30_60");
    ...
    return (_jsxs("div", { className: "page-stack inventory-workspace", children: [_jsxs("section", { className: "panel inventory-shell", children: [_jsxs("div", { className: "panel-header", children: [_jsxs("div", { children: [_jsx("p", { className: "eyebrow", children: "Estoque" }), _jsx("h2", { className: "premium-header-title", children: activeTab.title }), _jsx("p", { className: "panel-subcopy", children: activeTab.helper })] }), _jsx("div", { className: "inventory-shell-actions", children: canRefresh ? (_jsxs("button", { type: "button", className: "ghost-button", onClick: () => refreshMutation.mutate(), disabled: refreshMutation.isPending, children: [_jsx(RefreshCcw, { size: 16 }), refreshMutation.isPending ? "Atualizando..." : "Atualizar planilha"] })) : null })] }), _jsx("div", { className: "chart-switcher customers-view-switcher inventory-view-switcher", role: "tablist", "aria-label": "Abas de estoque", children: viewTabs.map((tab) => (_jsx("button", { type: "button", role: "tab", "aria-selected": activeView === tab.value, "aria-pressed": activeView === tab.value, className: `chart-switch-button ${activeView === tab.value ? "active" : ""}`, onClick: () => setActiveView(tab.value), children: _jsx("strong", { children: tab.label }) }, tab.value))) }), _jsxs("div", { className: "inventory-shell-meta", children: [_jsxs("span", { className: "inventory-shell-badge", children: [_jsx(Warehouse, { size: 14 }), snapshotMeta ? `Ultima leitura: ${formatDateTime(snapshotMeta.importedAt)}` : "Sem leitura da planilha ainda"] }), snapshotMeta ? (_jsxs(_Fragment, { children: [_jsxs("span", { className: "inventory-shell-badge", children: [_jsx(Boxes, { size: 14 }), formatNumber(snapshotMeta.inStockRows), " SKUs com saldo"] }), _jsxs("span", { className: "inventory-shell-badge", children: [_jsx(Tags, { size: 14 }), formatNumber(snapshotMeta.totalRows), " linhas na planilha"] })] })) : null] })] }), activeView === "overview" ? (_jsxs(_Fragment, { children: [_jsx("section", { className: "inventory-focus-grid", children: (overviewQuery.data?.cards ?? []).map((card) => (_jsx(InventoryFocusCard, { card: card, onClick: handleOverviewCardClick }, card.key))) }), _jsxs("section", { className: "panel", children: [_jsxs("div", { className: "inventory-section-heading", children: [_jsxs("div", { children: [_jsx("p", { className: "eyebrow", children: "Leitura visual" }), _jsx("h3", { children: "Cada grafico mostra uma coisa" }), _jsx("p", { className: "panel-subcopy", children: "Separei estoque, variedade e vendas para a leitura ficar mais clara." })] }), _jsxs("div", { style: { display: "flex", gap: "32px", textAlign: "right" }, children: [_jsxs("div", { className: "inventory-row-numbers", children: [_jsx("strong", { children: formatNumber(overviewQuery.data?.totals.totalStockUnitsTela ?? 0) }), _jsx("span", { children: "Telas em estoque" })] }), _jsxs("div", { className: "inventory-row-numbers", children: [_jsx("strong", { children: formatNumber(overviewQuery.data?.totals.totalStockUnitsDoc ?? 0) }), _jsx("span", { children: "DOCs em estoque" })] }), _jsxs("div", { className: "inventory-row-numbers", children: [_jsx("strong", { children: formatNumber(overviewQuery.data?.totals.totalStockUnits ?? 0) }), _jsx("span", { children: "Pecas totais agora" })] })] })] }), _jsx(InventoryTrendChart, { series: overviewQuery.data?.dailySeries ?? [] }), _jsx("div", { className: "inventory-story-grid", children: (overviewQuery.data?.highlights ?? []).map((line) => (_jsxs("article", { className: "inventory-story-card", children: [_jsx(TrendingUp, { size: 16 }), _jsx("span", { children: line })] }, line))) })] }), _jsxs("section", { className: "inventory-summary-grid", children: [_jsxs("article", { className: "panel inventory-summary-panel", children: [_jsx("div", { className: "inventory-section-heading", children: _jsx("h3", { children: "Leitura do dia" }) }), _jsxs("div", { className: "inventory-summary-list", children: [_jsxs("div", { children: [_jsx("span", { children: "SKUs ativos totais" }), _jsx("strong", { children: formatNumber(overviewQuery.data?.totals.activeSkuCount ?? 0) })] }), _jsxs("div", { children: [_jsx("span", { children: "SKUs Telas" }), _jsx("strong", { children: formatNumber(overviewQuery.data?.totals.activeSkuCountTela ?? 0) })] }), _jsxs("div", { children: [_jsx("span", { children: "SKUs DOCs" }), _jsx("strong", { children: formatNumber(overviewQuery.data?.totals.activeSkuCountDoc ?? 0) })] }), _jsxs("div", { children: [_jsx("span", { children: "Venda 30 dias" }), _jsx("strong", { children: formatNumber(overviewQuery.data?.totals.sales30 ?? 0) })] }), _jsxs("div", { children: [_jsx("span", { children: "Capital parado" }), _jsx("strong", { children: formatCurrency(overviewQuery.data?.totals.trappedValue ?? 0) })] })] })] }), _jsxs("article", { className: "panel inventory-summary-panel", children: [_jsx("div", { className: "inventory-section-heading", children: _jsx("h3", { children: "Proximo passo" }) }), _jsxs("div", { className: "inventory-next-actions", children: [_jsxs("button", { type: "button", className: "ghost-button", onClick: () => setActiveView("buying"), children: ["Ver compras ", _jsx(ArrowRight, { size: 14 })] }), _jsxs("button", { type: "button", className: "ghost-button", onClick: () => setActiveView("restock"), children: ["Ver reposicao ", _jsx(ArrowRight, { size: 14 })] }), _jsxs("button", { type: "button", className: "ghost-button", onClick: () => setActiveView("stale"), children: ["Ver estoque parado ", _jsx(ArrowRight, { size: 14 })] })] })] })] })] })) : null, activeView === "buying" ? (_jsxs(_Fragment, { children: [_jsx("section", { className: "panel inventory-inline-toolbar", children: _jsx("div", { className: "inventory-chip-row", children: [
                            ...
                            ].map((chip) => (_jsx("button", { type: "button", className: `inventory-filter-chip ${buyingFilter === chip.value ? "active" : ""}`, onClick: () => setBuyingFilter(chip.value), children: chip.label }, chip.value))) }) }), _jsx("section", { className: "inventory-card-list", children: visibleBuyingItems.length ? (_jsxs("section", { className: "panel inventory-stale-table-panel", children: [_jsxs("div", { className: "inventory-section-heading", children: [_jsxs("div", { children: [_jsx("p", { className: "eyebrow", children: "Compras" }), _jsx("h3", { children: "Tabela de compras" })] }), _jsxs("span", { children: [formatNumber(visibleBuyingItems.length), " SKUs"] })] }), _jsx("div", { className: "inventory-stale-table-wrap", children: _jsxs("table", { className: "data-table inventory-stale-table", children: [_jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { children: "SKU" }), _jsx("th", { children: "Tipo" }), _jsx("th", { children: "Em estoque" }), _jsx("th", { children: "Status SKU" }), _jsx("th", { children: "Venda 30/90" }), _jsx("th", { children: "Cobertura" }), _jsx("th", { children: "Ultima venda" }), _jsx("th", { children: "Ultima reposicao" }), _jsx("th", { children: "Valor em estoque" }), _jsx("th", { children: "Recomendacao" }), _jsx("th", { children: "Abrir" })] }) }), _jsx("tbody", { children: visibleBuyingItems.map((item) => (_jsxs("tr", { children: [_jsx("td", { children: _jsxs("div", { className: "inventory-stale-model-cell", children: [_jsx("strong", { children: item.sku }), _jsxs("span", { children: [item.modelLabel, " \u00B7 ", item.brand, " \u00B7 ", item.family] })] }) }), _jsx("td", { children: _jsx("span", { className: `inventory-status-pill tone-${productKindTone(item.productKind)}`, children: productKindLabel(item.productKind) }) }), _jsx("td", { children: _jsx("strong", { children: formatNumber(item.stockUnits) }) }), _jsxs("td", { children: [_jsx("strong", { children: item.activeSkuCount > 0 ? "Ativo" : "Sem saldo" }), _jsxs("span", { className: "inventory-table-secondary-text", children: [formatNumber(item.totalSkuCount), " linha(s)"] })] }), _jsx("td", { children: _jsxs("strong", { children: [formatNumber(item.sales30), " / ", formatNumber(item.sales90)] }) }), _jsx("td", { children: formatCoverage(item.coverageDays) }), _jsx("td", { children: formatDate(item.lastSaleAt) }), _jsx("td", { children: formatDate(item.lastRestockAt) }), _jsx("td", { children: _jsxs("div", { className: "inventory-stale-value-cell", children: [_jsx("strong", { children: formatCurrency(item.trappedValue) }), item.trappedValueEstimated ? _jsx("span", { className: "inventory-note-pill tone-warning", children: "Estimado" }) : null] }) }), _jsx("td", { children: _jsxs("div", { className: "inventory-stale-value-cell", children: [_jsx("span", { className: `inventory-status-pill tone-${buyRecommendationTone(item.buyRecommendation)}`, children: buyRecommendationLabel(item.buyRecommendation) }), item.holdSales ? _jsx("span", { className: "inventory-note-pill tone-danger", children: "Segurar venda" }) : null] }) }), _jsx("td", { children: _jsx("button", { type: "button", className: "primary-button small-button", onClick: () => openModel(item.modelKey), children: "Abrir analise" }) })] }, item.modelKey))) })] }) })] })) : (_jsx("div", { className: "empty-state", children: "Nenhum SKU entrou nesse filtro agora." })) })] })) : null, activeView === "restock" ? (_jsxs(_Fragment, { children: [_jsxs("section", { className: "inventory-summary-grid", children: [_jsxs("button", { type: "button", className: "panel inventory-summary-panel inventory-summary-clickable", onClick: () => setRestockWindow("today"), children: [_jsx("span", { children: "Chegou hoje" }), _jsx("strong", { children: formatNumber(restockQuery.data?.counts.arrivedToday ?? 0) })] }), _jsxs("button", { type: "button", className: "panel inventory-summary-panel inventory-summary-clickable", onClick: () => setRestockWindow("7d"), children: [_jsx("span", { children: "Chegou e voltou a vender" }), _jsx("strong", { children: formatNumber(restockQuery.data?.counts.backToSelling ?? 0) })] }), _jsxs("button", { type: "button", className: "panel inventory-summary-panel inventory-summary-clickable", onClick: () => setRestockWindow("30d"), children: [_jsx("span", { children: "Chegou e ainda nao girou" }), _jsx("strong", { children: formatNumber(restockQuery.data?.counts.noReactionYet ?? 0) })] }), _jsxs("article", { className: "panel inventory-summary-panel", children: [_jsx("span", { children: "Ainda precisa repor" }), _jsx("strong", { children: formatNumber(restockQuery.data?.counts.restockAgain ?? 0) })] })] }), _jsx("section", { className: "panel inventory-inline-toolbar", children: _jsx("div", { className: "inventory-chip-row", children: [
                                { value: "all", label: "Tudo" },
                                { value: "today", label: "Hoje" },
                                { value: "7d", label: "7 dias" },
                                { value: "30d", label: "30 dias" },
                            ].map((chip) => (_jsx("button", { type: "button", className: `inventory-filter-chip ${restockWindow === chip.value ? "active" : ""}`, onClick: () => setRestockWindow(chip.value), children: chip.label }, chip.value))) }) }), _jsx("section", { className: "inventory-card-list", children: visibleRestockItems.length ? (_jsxs("section", { className: "panel inventory-stale-table-panel", children: [_jsxs("div", { className: "inventory-section-heading", children: [_jsxs("div", { children: [_jsx("p", { className: "eyebrow", children: "Reposicao" }), _jsx("h3", { children: "Tabela de reposicao" })] }), _jsxs("span", { children: [formatNumber(visibleRestockItems.length), " SKUs"] })] }), _jsx("div", { className: "inventory-stale-table-wrap", children: _jsxs("table", { className: "data-table inventory-stale-table", children: [_jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { children: "SKU" }), _jsx("th", { children: "Tipo" }), _jsx("th", { children: "Ultima entrada" }), _jsx("th", { children: "Entrou" }), _jsx("th", { children: "Antes / Depois" }), _jsx("th", { children: "Venda 7d antes" }), _jsx("th", { children: "Venda 7d depois" }), _jsx("th", { children: "Em estoque" }), _jsx("th", { children: "Cobertura" }), _jsx("th", { children: "Recomendacao" }), _jsx("th", { children: "Status" }), _jsx("th", { children: "Abrir" })] }) }), _jsx("tbody", { children: visibleRestockItems.map((item) => (_jsxs("tr", { children: [_jsx("td", { children: _jsxs("div", { className: "inventory-stale-model-cell", children: [_jsx("strong", { children: item.sku }), _jsxs("span", { children: [item.modelLabel, " \u00B7 ", item.brand, " \u00B7 ", item.family] })] }) }), _jsx("td", { children: _jsx("span", { className: `inventory-status-pill tone-${productKindTone(item.productKind)}`, children: productKindLabel(item.productKind) }) }), _jsx("td", { children: formatDate(item.lastRestockAt) }), _jsx("td", { children: _jsx("strong", { children: formatNumber(item.restockUnits) }) }), _jsx("td", { children: _jsxs("strong", { children: [formatNumber(item.stockBefore), " / ", formatNumber(item.stockAfter)] }) }), _jsx("td", { children: formatNumber(item.sales7Before) }), _jsx("td", { children: formatNumber(item.sales7After) }), _jsx("td", { children: _jsxs("div", { className: "inventory-stale-value-cell", children: [_jsx("strong", { children: formatNumber(item.stockUnits) }), _jsx("span", { className: "inventory-table-secondary-text", children: item.activeSkuCount > 0 ? "SKU ativo" : "Sem saldo" })] }) }), _jsx("td", { children: formatCoverage(item.coverageDays) }), _jsx("td", { children: _jsx("span", { className: `inventory-status-pill tone-${buyRecommendationTone(item.buyRecommendation)}`, children: buyRecommendationLabel(item.buyRecommendation) }) }), _jsx("td", { children: _jsx("span", { className: `inventory-status-pill tone-${restockStatusTone(item.status)}`, children: restockStatusLabel(item.status) }) }), _jsx("td", { children: _jsx("button", { type: "button", className: "primary-button small-button", onClick: () => openModel(item.modelKey), children: "Abrir analise" }) })] }, `${item.modelKey}-${item.lastRestockAt ?? "no-restock"}`))) })] }) })] })) : (_jsx("div", { className: "empty-state", children: "Nenhum SKU entrou nesse periodo agora." })) })] })) : null, activeView === "stale" ? (_jsxs(_Fragment, { children: [_jsx("section", { className: "inventory-summary-grid", children: [
                            { value: "30_60", label: "30 a 60 dias sem vender", count: staleQuery.data?.counts.stale30_60 ?? 0 },
                            { value: "60_90", label: "60 a 90 dias sem vender", count: staleQuery.data?.counts.stale60_90 ?? 0 },
                            { value: "90_120", label: "90 a 120 dias sem vender", count: staleQuery.data?.counts.stale90_120 ?? 0 },
                            { value: "120plus", label: "120+ dias sem vender", count: staleQuery.data?.counts.stale120plus ?? 0 },
                        ].map((card) => (_jsxs("button", { type: "button", "aria-pressed": staleFilter === card.value, className: `panel inventory-summary-panel inventory-summary-clickable ${staleFilter === card.value ? "selected" : ""}`, onClick: () => setStaleFilter(card.value), children: [_jsxs("div", { className: "inventory-summary-top", children: [_jsx("span", { children: card.label }), staleFilter === card.value ? (_jsxs("span", { className: "inventory-summary-selected-badge", children: [_jsx(CheckCircle2, { size: 14 }), "Selecionado"] })) : (_jsx("small", { className: "inventory-summary-hint", children: "Clique para filtrar" }))] }), _jsxs("div", { style: { marginTop: "0.4rem" }, children: [_jsxs("strong", { style: { fontSize: "1.55rem", display: "block", color: "#0f172a", marginBottom: "0.15rem" }, children: [formatNumber(card.count), " SKUs"] }), _jsxs("span", { style: { fontSize: "0.95rem", color: "#475569", display: "block", fontWeight: 600 }, children: [formatCurrency(card.value === "30_60" ? staleBucketValues.stale30_60 :
                                                    card.value === "60_90" ? staleBucketValues.stale60_90 :
                                                        card.value === "90_120" ? staleBucketValues.stale90_120 :
                                                            staleBucketValues.stale120plus), " parados"] })] })] }, card.value))) }), _jsx("section", { className: "inventory-card-list", children: visibleStaleItems.length ? (_jsxs("section", { className: "panel inventory-stale-table-panel", children: [_jsxs("div", { className: "inventory-section-heading", children: [_jsxs("div", { children: [_jsx("p", { className: "eyebrow", children: "Produtos parados" }), _jsx("h3", { children: "Tabela de produtos sem giro" })] }), _jsxs("span", { children: [formatNumber(visibleStaleItems.length), " SKUs"] })] }), _jsx("div", { className: "inventory-stale-table-wrap", children: _jsxs("table", { className: "data-table inventory-stale-table", children: [_jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { children: "SKU" }), _jsx("th", { children: "Modelo" }), _jsx("th", { children: "Tipo" }), _jsx("th", { children: "Dias sem vender" }), _jsx("th", { children: "Pecas" }), _jsx("th", { children: "Ultima venda" }), _jsx("th", { children: "Preco unitario" }), _jsx("th", { children: "Valor parado" }), _jsx("th", { children: "Ultima reposicao" }), _jsx("th", { children: "Acao sugerida" }), _jsx("th", { children: "Abrir" })] }) }), _jsx("tbody", { children: visibleStaleItems.map((item) => (_jsxs("tr", { children: [_jsx("td", { children: _jsx("code", { children: item.sku }) }), _jsx("td", { children: _jsxs("div", { className: "inventory-stale-model-cell", children: [_jsx("strong", { children: item.modelLabel }), _jsxs("span", { children: [item.brand, " \u00B7 ", item.family, item.color ? ` · ${item.color}` : "", item.quality ? ` · ${item.quality}` : ""] })] }) }), _jsx("td", { children: _jsx("span", { className: `inventory-status-pill tone-${productKindTone(item.productKind)}`, children: productKindLabel(item.productKind) }) }), _jsx("td", { children: _jsx("strong", { children: item.daysSinceLastSale === null ? "Sem venda" : `${formatNumber(item.daysSinceLastSale)} dias` }) }), _jsx("td", { children: formatNumber(item.stockUnits) }), _jsx("td", { children: formatDate(item.lastSaleAt) }), _jsx("td", { children: formatCurrency(item.unitPrice) }), _jsx("td", { children: _jsxs("div", { className: "inventory-stale-value-cell", children: [_jsx("strong", { children: formatCurrency(item.trappedValue) }), item.trappedValueEstimated ? _jsx("span", { className: "inventory-note-pill tone-warning", children: "Estimado" }) : null] }) }), _jsx("td", { children: formatDate(item.lastRestockAt) }), _jsx("td", { children: _jsx("span", { className: `inventory-status-pill tone-${staleActionTone(item.suggestedAction)}`, children: staleActionLabel(item.suggestedAction) }) }), _jsx("td", { children: _jsx("button", { type: "button", className: "primary-button small-button", onClick: () => openModel(item.modelKey), children: "Abrir analise" }) })] }, item.sku))) })] }) })] })) : (_jsx("div", { className: "empty-state", children: "Nenhum SKU entrou nessa faixa agora." })) })] })) : null, activeView === "models" ? (_jsxs(_Fragment, { children: [_jsx("section", { className: "panel inventory-search-panel", children: _jsxs("div", { className: "inventory-search-grid", children: [_jsxs("label", { children: ["Buscar SKU, modelo, marca ou familia", _jsx("input", { value: modelSearch, onChange: (event) => setModelSearch(event.target.value), placeholder: "Ex.: 1308-1, A05, Xiaomi" })] }), _jsxs("label", { children: ["Marca", _jsxs("select", { value: brandFilter, onChange: (event) => setBrandFilter(event.target.value), children: [_jsx("option", { value: "", children: "Todas" }), (modelsQuery.data?.filters.brands ?? []).map((brand) => (_jsx("option", { value: brand, children: brand }, brand)))] })] }), _jsxs("label", { children: ["Familia", _jsxs("select", { value: familyFilter, onChange: (event) => setFamilyFilter(event.target.value), children: [_jsx("option", { value: "", children: "Todas" }), (modelsQuery.data?.filters.families ?? []).map((family) => (_jsx("option", { value: family, children: family }, family)))] })] }), _jsxs("label", { children: ["Qualidade", _jsxs("select", { value: qualityFilter, onChange: (event) => setQualityFilter(event.target.value), children: [_jsx("option", { value: "", children: "Todas" }), (modelsQuery.data?.filters.qualities ?? []).map((quality) => (_jsx("option", { value: quality, children: quality }, quality)))] })] })] }) }), _jsxs("section", { className: "inventory-models-layout", children: [_jsxs("section", { className: "panel inventory-model-list-panel", children: [_jsxs("div", { className: "inventory-section-heading", children: [_jsxs("div", { children: [_jsx("p", { className: "eyebrow", children: "Catalogo" }), _jsx("h3", { children: "SKUs para analisar" })] }), _jsx("span", { children: formatNumber(visibleModels.length) })] }), _jsxs("div", { className: "inventory-model-list", children: [visibleModels.map((item) => (_jsxs("button", { type: "button", className: `inventory-model-button ${selectedModelKey === item.modelKey ? "active" : ""}`, onClick: () => setSelectedModelKey(item.modelKey), children: [_jsxs("div", { children: [_jsx("strong", { children: item.sku }), _jsxs("span", { children: [item.modelLabel, " \u00B7 ", productKindLabel(item.productKind), " \u00B7 ", item.qualityLabels.slice(0, 2).join(", ") || "Sem qualidade"] })] }), _jsxs("div", { className: "inventory-row-numbers", children: [_jsx("strong", { children: formatNumber(item.stockUnits) }), _jsx("span", { children: buyRecommendationLabel(item.buyRecommendation) })] })] }, item.modelKey))), !visibleModels.length ? _jsx("div", { className: "empty-state", children: "Nenhum SKU bateu com essa busca." }) : null] })] }), _jsx(ModelDetailPanel, { detail: detailQuery.data, isLoading: detailQuery.isLoading })] })] })) : null] }));
}
