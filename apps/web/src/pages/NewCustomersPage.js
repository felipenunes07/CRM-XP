...
function CacTooltip({ active, payload, label, }) {
    ...
    return (_jsxs("div", { className: "chart-tooltip", style: { backdropFilter: "blur(8px)", background: "rgba(255,255,255,0.9)", border: "1px solid rgba(217, 119, 6, 0.2)", borderRadius: "12px", boxShadow: "0 10px 15px -3px rgba(0, 0, 0, 0.1)" }, children: [_jsx("strong", { style: { color: "#0f172a" }, children: formatMonthLabel(label) }), _jsxs("div", { className: "chart-tooltip-count", style: { marginTop: "0.5rem" }, children: [_jsx("strong", { style: { color: "#d97706", fontSize: "1.2rem" }, children: formatCac(payload[0]?.value ?? null) }), _jsx("span", { style: { color: "#64748b" }, children: "custo por cliente adquirido" })] }), source && (_jsxs("div", { style: { marginTop: "0.5rem", paddingTop: "0.5rem", borderTop: "1px solid #f1f5f9", fontSize: "0.7rem", fontWeight: 800, color: source === 'api' ? '#b45309' : '#64748b', textAlign: "center", letterSpacing: "0.05em" }, children: ["FONTE: ", source === 'api' ? 'META ADS (API)' : 'PLANILHA (FALLBACK)'] }))] }));
}
...
export function NewCustomersPage() {
    ...
    return (_jsxs("div", { className: "page-stack", children: [_jsx("style", { children: styles }), _jsxs("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1.5rem" }, children: [_jsxs("div", { children: [_jsx("p", { className: "eyebrow", style: { margin: 0, marginBottom: "0.3rem", color: "var(--accent)", fontWeight: 700, letterSpacing: "0.1em" }, children: "M\u00C9TRICAS DE AQUISI\u00C7\u00C3O" }), _jsx("h2", { className: "premium-header-title", children: "Clientes Novos" })] }), _jsxs("div", { style: { display: "flex", gap: "1rem", alignItems: "center" }, children: [_jsx("label", { style: { fontSize: "0.85rem", fontWeight: 600, color: "#64748b" }, children: "M\u00EAs de Visualiza\u00E7\u00E3o:" }), _jsx("select", { value: activeMonth, onChange: (e) => setSelectedMonth(e.target.value), style: {
                                    ...
                                    outline: "none"
                                        ...
                                        }, children: metrics.spendSource === 'api' ? "API" : "PLANILHA" }))] }), _jsx("div", { className: "metric-value", style: { color: "#3b82f6" }, children: formatCurrency(metrics.spend) }), _jsxs("p", { className: "metric-helper", style: { display: "flex", alignItems: "center", gap: "0.35rem" }, children: [renderCurrencyTrend(metrics.spend, metrics.prevSpend), "vs ", formatCurrency(metrics.prevSpend)] })] }), _jsxs("div", { className: "premium-card", children: [_jsxs("div", { className: "metric-label", style: { display: "flex", justifyContent: "space-between", alignItems: "center" }, children: [_jsx("span", { children: "CAC no M\u00EAs" }), metrics.spendSource && (_jsx("span", { style: {
                                            fontSize: "0.6rem",
                                            padding: "0.15rem 0.4rem",
                                            borderRadius: "6px",
                                        ...
                                        padding: "1rem 1.25rem",
                                    }, children: [_jsxs("div", { style: { minWidth: 0 }, children: [_jsx("strong", { style: { display: "block", marginBottom: "0.3rem", color: "#1e293b", fontSize: "0.95rem" }, children: customer.displayName }), _jsxs("span", { style: { display: "block", color: "#64748b", fontSize: "0.82rem" }, children: [customer.customerCode || "Sem codigo", " \u2022 1\u00AA compra em ", formatDate(customer.firstOrderDate)] }), _jsxs("span", { style: { display: "block", color: "#64748b", fontSize: "0.82rem", marginTop: "0.35rem", fontWeight: 500 }, children: [_jsx("span", { style: { color: "#3b82f6" }, children: customer.firstAttendant ? `Atend: ${customer.firstAttendant}` : "Sem atendente" }), " \u2022", " ", formatCurrency(customer.firstOrderAmount), _jsxs("span", { style: { marginLeft: "0.5rem", padding: "0.1rem 0.4rem", background: "#f1f5f9", borderRadius: "4px", fontSize: "0.75rem" }, children: [customer.firstItemCount, " pe\u00E7as"] })] })] }), _jsx("div", { style: { display: "flex", alignItems: "center" }, children: _jsx(Link, { to: `/clientes/${customer.customerId}`, className: "premium-btn", children: "Abrir cliente" }) })] }, customer.customerId))) })) : (_jsxs("div", { className: "empty-state", style: { padding: "3rem 1rem", background: "#f8fafc", borderRadius: "16px", border: "1px dashed #cbd5e1" }, children: ["Nenhum cliente novo em ", formatMonthLabel(activeMonth), "."] }))] })] }), _jsxs("article", { className: "premium-panel", style: { marginTop: "2rem" }, children: [_jsxs("div", { style: { marginBottom: "1.5rem" }, children: [_jsx("p", { className: "metric-helper", style: { textTransform: "uppercase", fontSize: "0.75rem", fontWeight: 800, color: "var(--accent)", letterSpacing: "0.05em", marginBottom: "0.4rem" }, children: "Intelig\u00EAncia de Venda" }), _jsx("h3", { style: { fontSize: "1.25rem", margin: 0, color: "#0f172a", fontWeight: 700 }, children: "Sa\u00FAde do Neg\u00F3cio (LTV vs CAC)" }), _jsxs("p", { className: "metric-helper", style: { marginTop: "0.4rem" }, children: ["Rela\u00E7\u00E3o entre o valor vital\u00EDcio do cliente e o custo de aquisi\u00E7\u00E3o. O ideal \u00E9 LTV ", '>', " 3x CAC."] })] }), _jsxs("div", { style: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '1.5rem', marginTop: '1.5rem' }, children: [_jsxs("div", { style: { padding: '1.5rem', borderRadius: '16px', background: 'rgba(41, 86, 215, 0.03)', border: '1px solid rgba(41, 86, 215, 0.1)' }, children: [_jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: '0.5rem', color: '#64748b', fontSize: '0.8rem', fontWeight: 700, textTransform: 'uppercase', marginBottom: '0.5rem' }, children: [_jsx(TrendingUp, { size: 16 }), "LTV / CAC Ratio"] }), _jsxs("div", { style: { display: 'flex', alignItems: 'baseline', gap: '0.5rem' }, children: [_jsxs("span", { style: { fontSize: '2.5rem', fontWeight: 800, color: (metrics.ltvCacRatio ?? 0) >= 3 ? '#10b981' : (metrics.ltvCacRatio ?? 0) >= 1.5 ? '#f59e0b' : '#ef4444' }, children: [metrics.ltvCacRatio ? metrics.ltvCacRatio.toFixed(1) : '--', "x"] }), _jsx("span", { style: {
                                                    fontSize: '0.85rem',
                                                    fontWeight: 700,
                                                ...
                                                }, children: (metrics.ltvCacRatio ?? 0) >= 3 ? 'Saudável' : (metrics.ltvCacRatio ?? 0) >= 1.5 ? 'Atenção' : 'Crítico' })] }), _jsx("p", { style: { fontSize: '0.9rem', color: '#64748b', marginTop: '0.75rem', lineHeight: 1.5 }, children: (metrics.ltvCacRatio ?? 0) >= 3
                                            ...
                                            : (metrics.ltvCacRatio ?? 0) >= 1.5
                                                ...
                                                : 'Atenção: o custo de aquisição está muito próximo do retorno vitalício estimado.' })] }), _jsxs("div", { style: { display: 'flex', flexDirection: 'column', gap: '1rem', justifyContent: 'center' }, children: [_jsxs("div", { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '1rem', borderRadius: '12px', background: '#f8fafc', border: '1px solid #f1f5f9' }, children: [_jsx("span", { style: { fontSize: '0.9rem', color: '#64748b', fontWeight: 600 }, children: "Ticket M\u00E9dio Hist\u00F3rico" }), _jsx("strong", { style: { fontSize: '1rem', color: '#1e293b' }, children: formatCurrency(metrics.avgTicket) })] }), _jsxs("div", { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '1rem', borderRadius: '12px', background: '#f8fafc', border: '1px solid #f1f5f9' }, children: [_jsx("span", { style: { fontSize: '0.9rem', color: '#64748b', fontWeight: 600 }, children: "Vida do Cliente Estimada" }), _jsxs("strong", { style: { fontSize: '1rem', color: '#1e293b' }, children: [metrics.estimatedLifespanMonths?.toFixed(1), " meses"] })] }), _jsxs("div", { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '1rem', borderRadius: '12px', background: '#f8fafc', border: '1px solid #f1f5f9' }, children: [_jsx("span", { style: { fontSize: '0.9rem', color: '#64748b', fontWeight: 600 }, children: "Churn Rate Hist\u00F3rico" }), _jsxs("strong", { style: { fontSize: '1rem', color: '#1e293b' }, children: [((metrics.monthlyChurnRate ?? 0) * 100).toFixed(1), "%"] })] })] })] })] }), _jsxs("section", { className: "premium-panel", style: { marginTop: "1.5rem" }, children: [_jsxs("div", { style: { marginBottom: "1.5rem" }, children: [_jsx("h3", { style: { fontSize: "1.25rem", margin: 0, color: "#0f172a", fontWeight: 700 }, children: "Hist\u00F3rico mensal" }), _jsx("p", { className: "metric-helper", style: { marginTop: "0.4rem" }, children: "Evolucao da aquisicao desde o primeiro mes com pedidos no CRM." })] }), _jsx("div", { style: { width: "100%", height: "280px", marginBottom: "2rem" }, children: _jsx(ResponsiveContainer, { children: _jsxs(ComposedChart, { syncId: "acquisition-history", syncMethod: "value", data: data.monthlySeries, margin: { top: 8, right: 12, left: 0, bottom: 0 }, children: [_jsx(CartesianGrid, { stroke: "#f1f5f9", vertical: false, strokeDasharray: "4 4" }), _jsx(XAxis, { dataKey: "month", ticks: monthlyTicks, tickFormatter: formatMonthLabel, tick: { fill: "#64748b", fontSize: 12, fontWeight: 500 }, tickLine: false, axisLine: false, interval: 0, dy: 10 }), _jsx(YAxis, { yAxisId: "customers", allowDecimals: false, tick: { fill: "#64748b", fontSize: 12, fontWeight: 500 }, tickLine: false, axisLine: false, width: 48, dx: -10 }), _jsx(YAxis, { yAxisId: "spend", orientation: "right", tickFormatter: (value) => formatCurrency(value), tick: { fill: "#64748b", fontSize: 12, fontWeight: 500 }, tickLine: false, axisLine: false, width: 90, dx: 10 }), _jsx(Tooltip, { content: _jsx(MonthlyTooltip, {}), cursor: { fill: "rgba(59, 130, 246, 0.05)" } }), _jsx(Bar, { yAxisId: "customers", dataKey: "newCustomers", fill: "#10b981", radius: [6, 6, 0, 0], maxBarSize: 50, cursor: "pointer", onClick: (_, index) => {
