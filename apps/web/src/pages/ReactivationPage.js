...
import { Calendar, UserCheck, TrendingUp, ExternalLink, Award, Medal, Camera, ShoppingBag, History } from "lucide-react";
...
export function ReactivationPage() {
    ...
    return (_jsxs("div", { className: "page-stack", children: [_jsxs("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: "0.5rem" }, children: [_jsxs("div", { children: [_jsx("p", { className: "eyebrow", style: { margin: 0, marginBottom: "0.2rem" }, children: "Ranking de Reativa\u00E7\u00E3o" }), _jsx("h2", { className: "premium-header-title", children: "Reativa\u00E7\u00E3o de Cliente" })] }), _jsxs("button", { onClick: () => setIsCompactMode(!isCompactMode), style: {
                            ...
                            alignItems: "center",
                            gap: "0.5rem"
                        }, children: [_jsx(TrendingUp, { size: 18 }), "Gr\u00E1ficos"] })] }), activeTab === "current" && (_jsxs(_Fragment, { children: [_jsxs("div", { className: "stats-grid", style: { display: isCompactMode ? "none" : "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "1rem", paddingBottom: "1rem" }, children: [_jsxs("div", { className: "stat-card tone-neutral", children: [_jsxs("div", { className: "stat-card-header", children: [_jsx("p", { className: "stat-card-title", children: "M\u00EAs analisado" }), _jsx("div", { className: "stat-card-icon", children: _jsx(Calendar, {}) })] }), _jsx("div", { className: "stat-card-body", children: _jsx("strong", { children: monthLabel }) }), _jsx("div", { className: "stat-card-footer", children: _jsx("span", { className: "stat-card-helper", children: "Per\u00EDodo do placar consolidado" }) })] }), _jsxs("div", { className: "stat-card tone-success", children: [_jsxs("div", { className: "stat-card-header", children: [_jsx("p", { className: "stat-card-title", children: "Recuperados" }), _jsx("div", { className: "stat-card-icon", children: _jsx(UserCheck, {}) })] }), _jsx("div", { className: "stat-card-body", children: _jsx("strong", { children: formatNumber(totalRecoveredCustomers) }) }), _jsx("div", { className: "stat-card-footer", children: _jsx("span", { className: "stat-card-helper", children: "Inativos +90 dias" }) })] }), _jsxs("div", { className: "stat-card tone-warning", children: [_jsxs("div", { className: "stat-card-header", children: [_jsx("p", { className: "stat-card-title", children: "Faturamento" }), _jsx("div", { className: "stat-card-icon", children: _jsx(TrendingUp, {}) })] }), _jsx("div", { className: "stat-card-body", children: _jsx("strong", { children: formatCurrency(totalRecoveredRevenue) }) }), _jsx("div", { className: "stat-card-footer", children: _jsx("span", { className: "stat-card-helper", children: "Retornado ao caixa" }) })] }), _jsxs("div", { className: "stat-card tone-purple", children: [_jsxs("div", { className: "stat-card-header", children: [_jsx("p", { className: "stat-card-title", children: "Pe\u00E7as Vendidas" }), _jsx("div", { className: "stat-card-icon", children: _jsx(ShoppingBag, {}) })] }), _jsx("div", { className: "stat-card-body", children: _jsx("strong", { children: formatNumber(totalRecoveredItems) }) }), _jsx("div", { className: "stat-card-footer", children: _jsx("span", { className: "stat-card-helper", children: "Total em produtos" }) })] })] }), _jsxs("section", { className: "panel", style: { padding: "0", display: "flex", flexDirection: "column", overflow: "hidden" }, children: [_jsx("div", { className: "panel-header", style: { padding: "1.5rem 1.5rem 1.25rem", borderBottom: "1px solid var(--line)", background: "transparent" }, children: _jsxs("div", { children: [_jsx("h3", { style: { fontSize: "1.2rem", margin: 0 }, children: "Placar Consolidado" }), _jsx("p", { className: "panel-subcopy", style: { marginTop: "0.3rem" }, children: "Detalhamento da convers\u00E3o por consultor e seus respectivos clientes reativados." })] }) }), leaderboard.length ? (_jsx("div", { className: "leaderboard-list", style: { padding: "1.5rem", display: "flex", flexDirection: "column", gap: "1.5rem", background: "var(--bg-soft)" }, children: leaderboard.map((entry, index) => (_jsxs("article", { className: "leaderboard-card", style: { background: "#fff", borderRadius: "12px", overflow: "hidden", boxShadow: index === 0 ? "0 4px 20px rgba(208, 154, 41, 0.15)" : "0 4px 15px rgba(0,0,0,0.03)", border: index === 0 ? "2px solid rgba(208, 154, 41, 0.4)" : "1px solid var(--line)" }, children: [_jsxs("div", { style: {
