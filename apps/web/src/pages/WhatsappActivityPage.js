...
function DailySummaryTab({ token }) {
    ...
    return (_jsxs("div", { className: "daily-summary-tab animate-in", style: { display: "flex", flexDirection: "column", gap: "2rem" }, children: [_jsx("div", { className: "panel", style: { padding: "1.5rem" }, children: _jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "1rem" }, children: [_jsxs("div", { style: { display: "flex", alignItems: "center", gap: "0.75rem" }, children: [_jsx(Calendar, { className: "muted", size: 20 }), _jsxs("div", { children: [_jsx("h3", { style: { margin: 0, fontSize: "1.1rem" }, children: "Selecione a data do relat\u00F3rio" }), _jsx("p", { className: "muted", style: { margin: 0, fontSize: "0.85rem" }, children: "Visualizando acontecimentos comerciais consolidados do dia" })] })] }), _jsxs("div", { style: { display: "flex", alignItems: "center", gap: "1rem" }, children: [_jsx("input", { type: "date", className: "form-input", style: { padding: "0.5rem 1rem", borderRadius: "8px", border: "1px solid var(--border-color)", width: "auto" }, value: selectedDate, onChange: (e) => setSelectedDate(e.target.value) }), _jsxs("button", { type: "button", className: "premium-button ghost", onClick: () => summaryQuery.refetch(), style: { display: "flex", alignItems: "center", gap: "0.5rem" }, children: [_jsx(RefreshCw, { size: 16 }), "Atualizar"] })] })] }) }), _jsxs("section", { className: "activity-metric-grid", style: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "1.5rem" }, children: [_jsxs("div", { className: "activity-metric-card", children: [_jsx("div", { className: "activity-metric-icon", style: { background: "rgba(40, 126, 231, 0.1)", color: "#287ee7" }, children: _jsx(Smartphone, { size: 18 }) }), _jsx("span", { children: "Clientes Novos" }), _jsx("div", { className: "activity-metric-value", children: _jsx("strong", { children: data.newCustomersCount }) }), _jsx("small", { children: "Primeira compra no dia" })] }), _jsxs("div", { className: "activity-metric-card", children: [_jsx("div", { className: "activity-metric-icon", style: { background: "rgba(16, 185, 129, 0.1)", color: "#10b981" }, children: _jsx(RefreshCw, { size: 18 }) }), _jsx("span", { children: "Clientes Recuperados" }), _jsx("div", { className: "activity-metric-value", children: _jsx("strong", { children: data.recoveredCustomersCount }) }), _jsx("small", { children: "Voltou a comprar ap\u00F3s 90+ dias" })] }), _jsxs("div", { className: "activity-metric-card", children: [_jsx("div", { className: "activity-metric-icon", style: { background: "rgba(245, 158, 11, 0.1)", color: "#f59e0b" }, children: _jsx(Package, { size: 18 }) }), _jsx("span", { children: "Telas Vendidas" }), _jsx("div", { className: "activity-metric-value", children: _jsx("strong", { children: data.totalTelasSold.toLocaleString("pt-BR") }) }), _jsx("small", { children: "Volume total de itens" })] }), _jsxs("div", { className: "activity-metric-card", children: [_jsx("div", { className: "activity-metric-icon", style: { background: "rgba(139, 92, 246, 0.1)", color: "#8b5cf6" }, children: _jsx(DollarSign, { size: 18 }) }), _jsx("span", { children: "Faturamento" }), _jsx("div", { className: "activity-metric-value", children: _jsxs("strong", { children: ["R$ ", data.totalRevenue.toLocaleString("pt-BR", { minimumFractionDigits: 2, maximumFractionDigits: 2 })] }) }), _jsx("small", { children: "Pedidos faturados no dia" })] }), _jsxs("div", { className: "activity-metric-card", children: [_jsx("div", { className: "activity-metric-icon", style: { background: "rgba(40, 126, 231, 0.1)", color: "#287ee7" }, children: _jsx(MessageCircle, { size: 18 }) }), _jsx("span", { children: "Respostas Enviadas" }), _jsx("div", { className: "activity-metric-value", children: _jsx("strong", { children: data.totalMessagesSent.toLocaleString("pt-BR") }) }), _jsx("small", { children: "Mensagens ativas do time" })] }), _jsxs("div", { className: "activity-metric-card", children: [_jsx("div", { className: "activity-metric-icon", style: { background: "rgba(107, 114, 128, 0.1)", color: "#6b7280" }, children: _jsx(Clock3, { size: 18 }) }), _jsx("span", { children: "Mensagens Recebidas" }), _jsx("div", { className: "activity-metric-value", children: _jsx("strong", { children: data.totalMessagesReceived.toLocaleString("pt-BR") }) }), _jsx("small", { children: "Entradas enviadas por clientes" })] })] }), _jsxs("div", { className: "panel", style: { padding: "2rem", display: "flex", flexDirection: "column", gap: "1.5rem" }, children: [_jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "1.5rem", borderBottom: "1px solid var(--border-color)", paddingBottom: "1rem" }, children: [_jsxs("div", { children: [_jsx("h3", { style: { margin: 0, fontSize: "1.2rem", fontWeight: 600 }, children: "Relat\u00F3rio Formatado para WhatsApp" }), _jsx("p", { className: "muted", style: { margin: "0.25rem 0 0 0", fontSize: "0.875rem" }, children: "Copie o relat\u00F3rio consolidado com cliques e publique direto no grupo da empresa." })] }), _jsxs("div", { style: { display: "flex", alignItems: "center", gap: "1.5rem", flexWrap: "wrap" }, children: [_jsxs("label", { style: { display: "flex", alignItems: "center", gap: "0.5rem", cursor: "pointer", fontSize: "0.9rem", fontWeight: 500, color: "var(--text-color)" }, children: [_jsx("input", { type: "checkbox", checked: isDetailed, onChange: (e) => setIsDetailed(e.target.checked), style: { width: "1.1rem", height: "1.1rem", cursor: "pointer", accentColor: "var(--primary)" } }), "Relat\u00F3rio Detalhado"] }), _jsxs("label", { style: { display: "flex", alignItems: "center", gap: "0.5rem", cursor: "pointer", fontSize: "0.9rem", fontWeight: 500, color: "var(--text-color)" }, children: [_jsx("input", { type: "checkbox", checked: useUniqueMessages, onChange: (e) => setUseUniqueMessages(e.target.checked), style: { width: "1.1rem", height: "1.1rem", cursor: "pointer", accentColor: "var(--primary)" } }), "Contatos \u00DAnicos Enviados (vs Total)"] }), _jsxs("button", { type: "button", className: `premium-button ${copySuccess ? "success" : "primary"}`, onClick: () => handleCopy(messageText), style: { display: "flex", alignItems: "center", gap: "0.5rem", transition: "all 0.2s ease" }, children: [copySuccess ? _jsx(Check, { size: 18 }) : _jsx(Copy, { size: 18 }), copySuccess ? "Copiado! ✅" : "Copiar para WhatsApp 📱"] })] })] }), _jsx("div", { style: {
