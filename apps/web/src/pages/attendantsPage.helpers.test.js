...
import { buildTrendChartData, getInitialSelectedAttendants, sortAttendantsForBoard, toggleComparedAttendant, } from "./attendantsPage.helpers";
function createAttendant(attendant, revenue, trendRevenue) {
    return {
        attendant,
        currentPeriod: {
            revenue,
